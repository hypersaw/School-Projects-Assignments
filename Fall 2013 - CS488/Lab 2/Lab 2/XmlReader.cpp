...
void XmlReader::openFile(const char * fileName) {
...
void XmlReader::parseCenter(xmlNode *node, int type) {
    xmlNode *currNode;
...
void XmlReader::parseCononicalVolume(xmlNode *ptr) {
...
void XmlReader::parseVRC(xmlNode *ptr) {
...
void XmlReader::parseNode(xmlNode *node, int type) {
...
void XmlReader::parseLineConnectivity(xmlNode *node,int type) {
...
void XmlReader::parseRadius(xmlNode *node, int type) {
...
void XmlReader::parseHeight(xmlNode *node, int type) {
...
void XmlReader::parseColor(xmlNode *node, int type) {
...
void XmlReader::parsePoints(xmlNode *node, int type) {
